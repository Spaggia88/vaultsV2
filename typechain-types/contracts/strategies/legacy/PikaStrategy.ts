...
export interface PikaStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PikaStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): PikaStrategy;
  waitForDeployment(): Promise<this>;

  interface: PikaStrategyInterface;
