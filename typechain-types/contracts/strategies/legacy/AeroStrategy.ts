...
export interface AeroStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "AeroToWant"
  ...
  encodeFunctionData(
    functionFragment: "balanceOfStaked",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "AeroToWant", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "LpToWant", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "adjustPosition",
    data: BytesLike
  ): Result;
...
export interface AeroStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): AeroStrategy;
  waitForDeployment(): Promise<this>;

  interface: AeroStrategyInterface;
  ...
  AeroToWant: TypedContractMethod<[amountIn: BigNumberish], [bigint], "view">;

  DEFAULT_PAYLOAD_SIZE_LIMIT: TypedContractMethod<[], [bigint], "view">;

  DEFAULT_SLIPPAGE: TypedContractMethod<[], [bigint], "view">;

  LpToWant: TypedContractMethod<[amountIn: BigNumberish], [bigint], "view">;
  ...
  balanceOfStaked: TypedContractMethod<[], [bigint], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "balanceOfStaked"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
