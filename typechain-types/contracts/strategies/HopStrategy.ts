...
export interface HopStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface HopStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): HopStrategy;
  waitForDeployment(): Promise<this>;

  interface: HopStrategyInterface;
