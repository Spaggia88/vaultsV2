...
export interface BeefyCompoundStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BEEFY_VAULT"
...
export interface BeefyCompoundStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): BeefyCompoundStrategy;
  waitForDeployment(): Promise<this>;

  interface: BeefyCompoundStrategyInterface;
