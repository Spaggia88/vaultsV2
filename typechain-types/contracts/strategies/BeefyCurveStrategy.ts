...
export interface BeefyCurveStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BEEFY_VAULT"
      | "CURVE_POOL"
...
export interface BeefyCurveStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): BeefyCurveStrategy;
  waitForDeployment(): Promise<this>;

  interface: BeefyCurveStrategyInterface;
  ...
  CURVE_POOL: TypedContractMethod<[], [string], "view">;
