...
export interface SaverStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface SaverStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): SaverStrategy;
  waitForDeployment(): Promise<this>;

  interface: SaverStrategyInterface;
  ...
  migrateMoney: TypedContractMethod<
