...
export interface IUSDCMockInterface extends Interface {
...
export interface IUSDCMock extends BaseContract {
  connect(runner?: ContractRunner | null): IUSDCMock;
  waitForDeployment(): Promise<this>;

  interface: IUSDCMockInterface;
